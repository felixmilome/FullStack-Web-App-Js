...
function LeftbarRow({Src, title, PersonName, Points}) {
    return (
        <div>
            ...
            <div className=" flex justify-center sm:justify-start bg-gray-200 items-center space-x-2 mt-0.5 py-2 px-2  rounded-l-full  hover:bg-white border-b border-gray-300 cursor-pointer group text-sm">
