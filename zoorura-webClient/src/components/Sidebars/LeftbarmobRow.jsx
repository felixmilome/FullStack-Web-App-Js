...
function LeftbarmobRow({Src, title, PersonName, Points}) {
    return (
        ...
        <div className="items-center space-x-2 mt-0.5 py-0.5 px-2 text-gray-500 hover:bg-white border-b-2 border-gray-300 cursor-pointer group">
           ...
           <p className= "inline-flex text-sm font-bold">
            ...
            <p className= "inline-flex text-sm font-light">
               {PersonName}</p> 
            <p className= "inline-flex font-bold text-sm text-gray-500">
               {Points}</p>
        </div>
        </div>
