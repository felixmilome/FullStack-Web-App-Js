...
function PostForm() {
    ...
    const handleUrl = (e) =>{
       const urInput = e.target.value;

       if(urInput.includes('www.youtube.com')){
       ...
       else if(urInput.includes('vm.tiktok.com')){ //tiktok errr-----------------
    ...
    return (
        <div className="flex items-center justify-center">
                <div className="space-y-5 w-full xl:w-2/5 bg-transparent items-center  z-40  m-4">
                    ...
                    {/*========== ========Preview Box ===========*/}
                                ...
                                {/* ======YOUTUBE======== */}
                                  { diariesData.file.length && diariesData.file.includes('www.youtube.com')?
                                    ...
                                    {/* tiktok app */}
                                    { diariesData.file.length && diariesData.file.includes('vm.tiktok.com')?
                                            <div >
                                            <div className='relative flex justify-center text-gray-400'>
                                                <SiTiktok/>
                                            </div>
                                          
                                            <p className= 'text-center text-red-400 p-1 text-xs' >Apologies. Tiktok Id not found. Kindly fetch Tiktok Link from Web-Browser and not App</p>
                                            </div>
                                       : 
                                       <>
