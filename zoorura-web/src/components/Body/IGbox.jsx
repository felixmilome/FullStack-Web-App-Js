    ...
    return (
        ...
        <div className="p-2 sm:px-12 py-4 rounded-xl bg-transparent relative xl:w-1/2 mx-auto my-1"> 
            ...
            <div className="flex  justify-center">
                {/* Top-Cyan */}
                <div className="bg-gray-100 rounded-full lg:w-2/3 w-full transition delay-50 py-0.5 flex items-center font-bold shadow-lg justify-between">
                        {/*Top-Mid*/}
        ...
        <div className="flex justify-center  my-0.5">
            {/* Post Mid Frame*/}
            <div className="w-full text-center items-center p-5 bg-transparent rounded-t-xl"> 
                                {/* <p className="leading-5 text-base font-bold my-1 text-gray-400">IG POST</p> */}
                                <p className="leading-5 text-sm font-medium text-gray-800">Ig guys be postin YOWW!!</p>                 
            </div>  
        </div>
        ...
        <div className="flex justify-center">
            {/* Post Mid Frame*/}
            <div className="rounded-xl max-h-screen transition delay-50 flex p-1 mx-3 items-center cursor-pointer bg-gray-300 font-bold hover:bg-gray-100">
        ...
        <div className="">
            ...
            {popTip && <TipModal />}
                    ...
                    <div className="relative flex items-center rounded-full p-1 cursor-pointer bg-gradient-to-r hover:bg-cyan-100 hover:from-blue-100 hover:to-green-100"
                        ...
                        <p className="font-light text-xs m-1 text-gray-800">10 Claptips</p>
