...
//nodemailer transporter
 let transporter = nodemailer.createTransport({
  ...
  export const sendSecurityEmail = async (remail, uniqueStr, userName, userId, change) => {
 ...
 export const sendDeleteAccountEmail = async (remail, uniqueStr, userName, userId) => {
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td>
                              ...
                              <a href= "http://localhost:3000/securityChange/deleteAccount/${userId}/${uniqueStr}"> <h1>DELETE MY ACCOUNT</h1> </a>
